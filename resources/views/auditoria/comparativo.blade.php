...
<div class="progress">
    ...
    <div class="container">
        <h4>Revise el comparativo de marcas</h4>
        <table class="table table-bordered data-table">
            ...
            <tbody>
                <tr>
                    <td>{{ $comparativo->id }}</td>
                    <td>{{ $comparativo->razonSocial }}</td>
                    <td>
                        <div class="btn-group" role="group" aria-label="BasicExample">
                            <a href="{{ url('/comparativo/' . $comparativo->id) }}" class="btn btn-warning btn-sm" style="border-radius: 0.75rem">para continuar haga click <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </td>
                </tr>
            </tbody>

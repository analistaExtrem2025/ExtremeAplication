...
<div class="progress">
    <div class="progress-bar" style="width:87%;">
        <span class="progress-bar-text">87% Diligenciado</span>
    </div>
</div>
    <div class="container">

        <h4>Entrega de gifts</h4>
        <table class="table table-bordered data-table">
            ...
            <tbody>
                <tr>
                    <td>{{ $gifts->id }}</td>
                    <td>{{ $gifts->razonSocial }}</td>
                    <td>
                        <div class="btn-group" role="group" aria-label="BasicExample">
                            <a href="{{ url('/gifts/' . $gifts->id) }}" class="btn btn-warning btn-sm" style="border-radius: 0.75rem">para continuar haga click <i class="fas fa-arrow-circle-right">  </i></a>
                        </div>
                    </td>
                </tr>
            </tbody>

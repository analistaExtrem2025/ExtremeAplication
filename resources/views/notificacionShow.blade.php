...
@section('content')
    <div class="container">
        ...
        <input class="dataPqr" type="text" name="estatusRespuesta" value="{{ $pqr->estatusRespuesta}}" disabled>
        <br><br>
        <span>Observaciones</span>

        <input class="dataPqr" type="text" name="observaciones" value="{{ $pqr->observaciones}}" disabled>
        <br><br>

...
<br><br><br>
<script>
    const data1 = {!!  json_encode($cerrados->lat)!!};
    const data2 = {!!  json_encode($cerrados->lon)!!};
    const namePoint = 'punto a visitar';
    const nameloc = {!!  json_encode($cerrados->localidad)!!};
